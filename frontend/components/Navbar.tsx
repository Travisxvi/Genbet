...
export function Navbar() {
  ...
  const totalBets = markets?.length || 0;
  const resolvedBets = markets?.filter(m => m.status === "SETTLED").length || 0;
          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg md:text-xl font-bold ml-2 text-gradient">GenBet</span>
              </div>
